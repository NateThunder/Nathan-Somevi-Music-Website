...
const modalInputClass =
  "w-full rounded-[8px] border border-white/20 bg-black/40 px-3 py-2.5 text-sm text-white placeholder:text-white/40 outline-none transition focus:border-[#e7a43c]/70 focus:ring-2 focus:ring-[#e7a43c]/30";
const modalSecondaryButtonClass =
  "rounded-[8px] border border-white/25 px-4 py-2 text-sm font-semibold text-white/80 transition hover:border-white/40 hover:bg-white/10";
const modalPrimaryButtonClass =
  "rounded-[8px] bg-[#e7a43c] px-5 py-2 text-sm font-semibold text-black transition hover:brightness-110";
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <button
                  ...
                  className="rounded-[8px] border border-white/10 bg-white/[0.06] p-6 text-left text-white shadow-[0_12px_30px_rgba(0,0,0,0.25)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_16px_34px_rgba(0,0,0,0.3)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e7a43c]"
                >
                  <p className="text-xs uppercase tracking-[0.25em] text-white/60">Events</p>
                  <p className="mt-3 font-anton text-5xl leading-none text-[#e7a43c]">{events.length}</p>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="mt-3 font-anton text-5xl leading-none text-[#e7a43c]">{releases.length}</p>
                ...
                >
                  ...
                  <p className="mt-3 font-anton text-5xl leading-none text-[#e7a43c]">{charts.length}</p>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="mt-3 font-anton text-5xl leading-none text-[#e7a43c]">{merch.length}</p>
                </button>
              </div>
            </div>
          )}
            ...
            <section className="space-y-5">
              <div className="flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="rounded-[8px] bg-[#e7a43c] px-5 py-2 text-base font-semibold text-black transition hover:brightness-110"
                >
                  + Add new
                </button>
              </div>
                ...
                {events.map((row) => (
                  <tr key={row.id} className="border-t border-white/10">
                    ...
                    <td className="px-4 py-3 flex items-center gap-2">
                      <button
                        type="button"
                        className="rounded-[8px] border border-white/20 px-4 py-1.5 text-sm font-semibold text-white/90 hover:bg-white/10"
              ...
              <div className="rounded-[8px] border border-white/10 bg-white/[0.04] p-5">
                ...
                {featuredVideoUrl ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-3 block break-all text-sm text-[#e7a43c] underline decoration-[#e7a43c]/40 underline-offset-4 hover:text-[#ffc768]"
                  >
                    {featuredVideoUrl}
                  </a>
                ) : (
        ...
        <form onSubmit={saveEvent} className="space-y-3">
          ...
          <label className="flex items-center gap-2 text-sm text-white/80">
            <input
              ...
              className="h-4 w-4 rounded border-white/30 bg-black/40 text-[#e7a43c] focus:ring-2 focus:ring-[#e7a43c]/50"
            />
            Free event?
          </label>
          <label className="flex items-center gap-2 text-sm text-white/80">
